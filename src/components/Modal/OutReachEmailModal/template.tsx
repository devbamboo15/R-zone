export const template = (orgName, programCode) => {
  return `
                    ...
                    <td>
                        <table style="width: 690px; margin: 0px auto;text-align: justify;">
                          <tbody>
                            ...
                            <tr>
                                <td style="font-size: 15px; line-height: 35px; padding-bottom: 20px;">The unique code for this reading program is: <span style="color: #FFC315; font-weight: bold; font-size: 30px;">${programCode}</span></td>
                            </tr>
                            <tr>
